...
preferences-feedback-help = Both open a form on GitHub in your browser. The bug form arrives with your plugin version, your Zotero version, your operating system, and this plugin's recent error messages already filled in. Each error message names the plugin file and line it came from; nothing outside the plugin's own folder is included. Nothing is sent until you submit the form, and you can edit every field first.
