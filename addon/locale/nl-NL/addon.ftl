...
preferences-feedback-help = Beide openen een formulier op GitHub in je browser. Het bugformulier is al ingevuld met je pluginversie, je Zotero-versie, je besturingssysteem en de recente foutmeldingen van deze plugin. Elke foutmelding noemt het pluginbestand en de regel waar die vandaan komt; niets buiten de map van de plugin zelf wordt meegestuurd. Er wordt niets verstuurd totdat je het formulier indient, en je kunt elk veld eerst aanpassen.
