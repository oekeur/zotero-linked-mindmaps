...
const SITE_DESCRIPTION =
  "A mind map plugin for Zotero 7 and later. Build a knowledge graph of your sources with typed, named links between items and notes, across multiple named mindmaps.";
